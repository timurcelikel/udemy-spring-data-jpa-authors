...
@Service
public class BookHibernateServiceImpl implements BookService {

	private final EntityManagerFactory emf;

	public BookHibernateServiceImpl(EntityManagerFactory emf) {
		this.emf = emf;
	}
	...
	public List<Book> findAllBooksSortByTitle(Pageable pageable) {
		...
		try {
			String hql =
				"SELECT b FROM Book b order by b.title " + pageable.getSort().getOrderFor(
					"title").getDirection().name();
